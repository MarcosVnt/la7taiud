<template>
  <div>
    ...
    <div class=" mb-3 content-start md:content-around justify-between items-center bg-green-200
                  ...
                  <div class="flex justify-between">
                    <div class="flex">
                      <div>
                        ...
                        <div class="h-12 w-12 rounded-full bg-cover" style="background-image: url(../img/Vile_m.JPG);"></div>
                      </div>

                      <div class="ml-4">
                        <div class="font-bold">Indique Nombre del Plato </div>
                        <div class="mt-1 text-xs text-gray-500">y Observaciones si es necesario</div>
                      </div>
                    </div>
                    <div class="text-yellow-400 flex items-center"><svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                      ...
                      </svg><span class="text-xl font-bold ml-2"></span></div>
                  </div>
   ...
   <div class="flex-auto w-full">
        ...
        <input
          ...
          class="w-full shadow-inner p-4 border-0 text-xs"
          type="number"
          placeholder="1.0" step="0.50" min="0" max="10"
          name="descripcion"
  ...
  <div class="flex justify-center mb-10 ">
    <button class="flex items-center bg-green-100 shadow-md border border-gray-200 rounded px-4 py-2 mr-10"  @click.prevent="guardar">
      <div class="text-indigo-700">Aceptar</div>
    </button>
    <button class="flex items-center bg-red-100 shadow-md border border-gray-200 rounded px-4 py-2 mr-2"  @click.prevent="cancelar">
