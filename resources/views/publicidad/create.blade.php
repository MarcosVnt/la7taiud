...
<h1 class="text-2xl text-center mt-10">Alta Publicidad</h1>
    
<form class="max-w-lg mx-auto my-10" 
        action="{{ route('publicidad.store') }}"
        method="POST"
    ...
    <div class="mb-5">
        ...
        >
            ...
            @foreach ($establecimiento_tipos as $establecimiento_tipo)
                <option 
                    {{ old('establecimiento_tipo') == $establecimiento_tipo->id ? 'selected' : '' }}
